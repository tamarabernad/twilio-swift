...
class ViewController: UIViewController, PKPushRegistryDelegate, TVONotificationDelegate, TVOCallDelegate, CXProviderDelegate {
    let baseURLString = "http://2720e5c2.ngrok.io"
    ...
    func provider(_ provider: CXProvider, perform action: CXStartCallAction) {
        ...
        call = VoiceClient.sharedInstance().call(accessToken, params: ["From":self.userId!,"To":self.tfReceiver.text!], delegate: self)
